...
if (!empty($_POST)) {
    ...
    if (!empty($_POST["cidade"])) { // Verifique se o campo de pesquisa por nome não está vazio
        $pesq = $_POST["cidade"];
        $selectCarro .= " AND cidadeImovel LIKE '%$pesq%'";
    }
    ...
    <div class="side-bar" id="sidebar">
        <div class="content-side">
            <div class="op3">
             ...
             <input type="text" name="cidade" placeholder="Digite onde..."><i class='bx bx-map'></i>
             </form>
                </div>
            </div>
            <div class="clean">
