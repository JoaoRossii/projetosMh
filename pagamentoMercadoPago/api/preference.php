...
// Verifica se houve um erro na solicitação cURL
if ($response === false) {
    // Obtém e imprime o erro
    $curl_error = curl_error($curl);
    die('Erro ao fazer a solicitação para a API: ' . $curl_error);
}

// Se a solicitação foi bem-sucedida, continue com o processamento da resposta
